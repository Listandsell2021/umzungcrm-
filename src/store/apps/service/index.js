...
export const fetchData = createAsyncThunk('appUsers/fetchData', async params => {
  const response = await axios.post('https://lscrmlive.vercel.app/api/getServiceData', {
    params
  })
  var test={
...
"status":"active"}
  ...
  const response = await axios.post('https://lscrmlive.vercel.app/api/postServices', {
    datanew
  })
...
"status":data.status}
  ...
  console.log(datanew)
  const response = await axios.post('https://lscrmlive.vercel.app/api/updateService', {
    datanew
  })
  dispatch(fetchData(getState().user.params))
...
export const deleteUser = createAsyncThunk('appUsers/deleteUser', async (s_id, { getState, dispatch }) => {
  ...
  const response = await axios.post('https://lscrmlive.vercel.app/api/deleteService', {
    datanew: s_id
  })
  dispatch(fetchData(getState().user.params))
