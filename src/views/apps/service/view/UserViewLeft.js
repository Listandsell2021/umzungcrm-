...
const [length, setlength] = useState(data.size.length)
const [breath, setbreath] = useState(data.size.breath)
const [height, setheight] = useState(data.size.height)
const [cubic_meter, setcubic_meter] = useState(data.size.cubic_meter)
            ...
            <CardContent>
              ...
              <Box sx={{ pt: 2, pb: 1 }}>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  ...
                  <Typography variant='body2'>{data.tittle}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                    Product Id:
                  </Typography>
                  <Typography variant='body2'>{data.p_id}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                    Status:
                ...
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                   <Typography sx={{ mr: 2, fontWeight: 800, fontSize: '0.875rem' }}>Size-</Typography>
                  
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                 <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Length:</Typography>
                  <Typography variant='body2'> {data.size.length}</Typography>
                  
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                 <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Height:</Typography>
                  <Typography variant='body2'> {data.size.breath}</Typography>
                  
                </Box>
                <Box sx={{ display: 'flex' }}>
                   <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Breath:</Typography>
                  <Typography variant='body2'> {data.size.height}</Typography>
                </Box>
                <Box sx={{ display: 'flex' }}>
                   <Typography sx={{ mr: 3, fontWeight: 500, fontSize: '0.875rem' }}>Cubic Meter:</Typography>
                  <Typography variant='body2'> {data.size.cubic_meter}</Typography>
                </Box>
              </Box>
            </CardContent>
                ...
                <form>
                  <Grid container spacing={6}>
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth label='Title Product' value={tittle} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField
                        fullWidth
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth type='email' label='Product' value={length} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
